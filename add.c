...
int bt[15];
int n;
printf("Enter th enumber of processes:");
scanf("%d",&n);
...
printf("Enter the nurst time of all the processes:");
for(int i=0;i<n;i++)
{
scanf("%d",&bt[i]);
}
...
>>>>>>> 9f306db9a0de12fe309f9a17ade5abed45ab7390
=======
#include <stdio.h>
int main()
{
    ...
    printf("Avg. waiting time= %f\n",awt);
    printf("Avg. turnaround time= %f",att);
>>>>>>> 4e5264b1ce18f91742872532289de7f9f4ea50cf
}
